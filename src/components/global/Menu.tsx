...
const Menu = () => {
  ...
  const bfLoginLinks = [
    ...
    { label: 'Summary Report', path: '/searchdata2' },
    { label: 'Frequency Report', path: '/search_frequency' }
  ]

  const afLoginLinks = [
    { label: 'Home', path: `/profile/${auth.user?._id}` },
    { label: 'Search', path: '/searchdate' },
    ...
    <ul className="navbar-nav ms-auto">
     ...
     {/**  {
        ...
        <li className={`nav-item ${isActive("/category")}`}>
          <Link to="/searchdata2" className="nav-link">Report</Link>
        </li>
      } */}
