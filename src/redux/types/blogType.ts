...
export const GET_BLOGS_BRANCH = "GET_BLOGS_BRANCH"
...
export interface IGetBarnchBlogsType{
  type: typeof GET_BLOGS_BRANCH,
  payload: IBranchBlogs[]
}
